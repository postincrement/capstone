...
DEP_Z80 =
DEP_Z80 += $(wildcard arch/Z80/Z80*.inc)

LIBOBJ_Z80 =
ifneq (,$(findstring z80,$(CAPSTONE_ARCHS)))
	CFLAGS += -DCAPSTONE_HAS_Z80
	LIBSRC_Z80 += $(wildcard arch/Z80/Z80*.c)
	LIBOBJ_Z80 += $(LIBSRC_Z80:%.c=$(OBJDIR)/%.o)
endif
...
LIBOBJ += $(LIBOBJ_Z80) $(OBJDIR)/MCInst.o
